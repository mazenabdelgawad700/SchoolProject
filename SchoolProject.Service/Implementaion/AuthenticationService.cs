    ...
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<JwtAuthResponse> GetJWTTokenAsync(User user)
        {
            ...
            var userRefreshToken = new UserRefreshToken
            {
                ...
                ExpiryAt = DateTime.Now.AddDays(_jwtSettings.RefreshTokenExpireDate),
                IsUsed = true,
                IsRevoked = false,
                JwtId = jwtToken.Id,
        ...
        public async Task<(string, DateTime?)> ValidateDetailsAsync(JwtSecurityToken jwtToken, string accessToken, string refreshToken)
        {
            ...
            if (userRefreshToken.ExpiryAt < DateTime.UtcNow)
            {
            ...
            var expirydate = userRefreshToken.ExpiryAt;
